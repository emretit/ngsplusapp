        ...
        <View style={[styles.formContainer, { backgroundColor: isDark ? Colors.card.dark : '#FFFFFF' }]}>
          ...
          <View style={styles.inputContainer}>
            ...
            <View style={[
              ...
              <Feather name="mail" size={20} color={isDark ? '#888888' : '#999999'} style={styles.inputIcon} />
              <TextInput
                style={[styles.input, { color: isDark ? Colors.text.dark : Colors.text.light }]}
                placeholder="E-posta"
                placeholderTextColor={isDark ? '#888888' : '#999999'}
            ...
            <View style={[
              ...
              <Feather name="phone" size={20} color={isDark ? '#888888' : '#999999'} style={styles.inputIcon} />
              <TextInput
                style={[styles.input, { color: isDark ? Colors.text.dark : Colors.text.light }]}
